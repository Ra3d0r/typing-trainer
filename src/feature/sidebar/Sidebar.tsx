	...
	return (
		<>
			<button
				...
				type="button"
				className="inline-flex absolute z-10 items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
			...
			<aside
				...
				} top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0`}
				aria-label="Sidenav"
			>
